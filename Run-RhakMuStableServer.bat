...
echo Profile: host identity, original start relay, member list broadcast
powershell -NoProfile -ExecutionPolicy Bypass -File ".\Start-RhakMuDummyServer.ps1" -AutoReply none -RoomJoinIdentityMode host -GameStartSyncMode original -ChannelUserListReplyMode members
pause
