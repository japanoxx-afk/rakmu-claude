...
powershell -NoProfile -ExecutionPolicy Bypass -File ".\Start-RhakMuDummyServer.ps1" -AutoReply none -RoomJoinIdentityMode joiner -GameStartSyncMode original-plus-stage8
pause
