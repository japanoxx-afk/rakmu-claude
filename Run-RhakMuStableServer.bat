...
echo Profile: host identity, direct client start path, member list broadcast
powershell -NoProfile -ExecutionPolicy Bypass -File ".\Start-RhakMuDummyServer.ps1" -AutoReply none -RoomJoinIdentityMode host -GameStartSyncMode none -ChannelUserListReplyMode members
pause
